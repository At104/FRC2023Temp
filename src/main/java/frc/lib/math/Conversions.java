...
public class Conversions {
    ...
    /**
     * @param positionCounts BoreEncoder Position Counts
     * @param gearRatio Gear Ratio between BoreEncoder and Mechanism
     * @return Degrees of Rotation of Mechanism
     */
    public static double boreEncoderToDegrees(double positionCounts, double gearRatio) {
     ...
     * @param gearRatio Gear Ratio between BoreEncoder and Mechanism
     * @return BoreEncoder Position Counts
     */
    public static double degreesToBoreEncoder(double degrees, double gearRatio) {
