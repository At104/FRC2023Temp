...
public class SwerveModule {
    ...
    public SwerveModule(int moduleNumber, SwerveModuleConstants moduleConstants){
        ...
        angleEncoder = new DutyCycleEncoder(moduleConstants.boreEncoderID);
        angleEncoder.setDistancePerRotation(4096);
        //configAngleEncoder();
    ...
    public Rotation2d getBoreEncoder(){
        return Rotation2d.fromDegrees(angleEncoder.getAbsolutePosition());
    }

    public void resetToAbsolute(){
        double absolutePosition = Conversions.degreesToFalcon(getBoreEncoder().getDegrees() - angleOffset.getDegrees(), Constants.Swerve.angleGearRatio);
